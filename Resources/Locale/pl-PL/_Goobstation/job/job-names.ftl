job-name-futureagent = Przyszły Agent
job-name-salvagediver = Zbieracz
job-name-ntr = Przedstawiciel Nanotrasen
job-name-bs = Niebieska Tarcza
job-name-overall = Ogólne
...
JobBlueshieldOfficer = Oficer "Niebieska Tarcza"
JobNanotrasenRepresentative = Przedstawiciel Nanotrasen
